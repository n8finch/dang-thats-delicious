...
function autocomplete(input, latInput, lngInput) {
	if (!input) return; //stop from running if no input on page
...
function loadPlaces(map) {
	...
	_axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
		...
		//click on a marker to show infoWindow
		...
		// zoom in on the map to get markers set
...
// Could use navigator.geolocation.getCurrentPosition to get user's location
